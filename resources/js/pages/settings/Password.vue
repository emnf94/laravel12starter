        ...
        <SettingsLayout>
            <div class="space-y-6">
                <HeadingSmall title="Update password"
                    description="Pastikan akun Anda menggunakan kata password yang panjang dan acak agar tetap aman." />
                ...
                <form @submit.prevent="updatePassword" class="space-y-6">
                    ...
                    <div class="grid gap-2">
                        ...
                        <Input id="password" ref="passwordInput" v-model="form.password" type="password"
                            class="mt-1 block w-full" autocomplete="new-password" placeholder="Password baru" />
                    ...
                    <div class="grid gap-2">
                        ...
                        <Input id="password_confirmation" v-model="form.password_confirmation" type="password"
                            class="mt-1 block w-full" autocomplete="new-password" placeholder="Konfirmasi password" />
